# -*- coding: utf-8 -*-
"""
Created on Mon Jan 02 17:00:46 2017
...
class MYSVM(SIL):
    ...
    def fit(self, bags, y):
        ...
        for rr in range(self.restarts + 1):
            ...
            cccp = MYSVMCCCP(verbose=self.verbose, svm=None, selectors=None,
    ...
    def get_params(self, deep=True):
        super_args = super(MYSVM, self).get_params()
...
class mySVM(SIL):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(mySVM, self).__init__(*args, **kwargs)
    ...
    def fit(self, bags, y):
        ...
        for rr in range(self.restarts + 1):
            ...
            cccp = mySVMCCCP(verbose=self.verbose, svm=None,
